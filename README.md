...
Each release ships the `eth-ssz-specs` package on PyPI and the conformance vectors on
the [releases page](https://github.com/leanEthereum/ssz-specs/releases), both built
